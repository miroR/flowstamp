#!/bin/bash
#
# Fs_LENTO_r30_at00000.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_LENTO_r30_at00000.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_LENTO_r30_at00000.sh Fs_at00000.png &> /dev/null"
./Fs_licet_LENTO_r30_at00000.sh Fs_at00000.png &> /dev/null
...
#read FAKE
mv -iv Fs_LENTO_at0_on_black_nLOGO.d/  Fs_LENTO_at0_on_black_nLOGO.d_768/
mkdir -p Fs_LENTO_at0_on_black_nLOGO.d
for i in $(<ls-1_1376)
	do
		convert -define png:color-type=6 -resize 1920x1080 \
			Fs_LENTO_at0_on_black_nLOGO.d_768/Fs_LENTO_at0_on_black_nLOGO-$i.png \
			Fs_LENTO_at0_on_black_nLOGO.d/Fs_LENTO_at0_on_black_nLOGO-$i.png
	done
...
ffmpeg -y -framerate 30 -i \
	...
	-c qtrle -r 30 Fs_LENTO_r30_at0_on_black_nLOGO.mov
