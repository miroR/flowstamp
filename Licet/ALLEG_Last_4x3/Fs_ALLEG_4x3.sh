#!/bin/bash
#
# Fs_ALLEG_4x3.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_ALLEG_4x3.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_ALLEG_4x3.sh Fs_4x3.png &> /dev/null"
./Fs_licet_ALLEG_4x3.sh Fs_4x3.png &> /dev/null
...
ffmpeg -y -i \
	...
	-c qtrle Fs_ALLEG_4x3_on_black_nLOGO.mov
