#!/bin/bash
#
# Fs_licet_ALLEG_4x3r50.sh -- this script is part of Flowstamp program
#
...
r1=`echo $1|sed 's/.png//'`
r1r=`echo $1|sed 's/_4x3/_ALLEG_4x3/'|sed 's/.png//'`
echo \$r1: ; echo $r1
echo \$r1r:
echo $r1r
#read FAKE
...
cd $r1r.d/
mkdir -p ../JIC
cat ../ls-1_9999| head -n1000 > ../ls-1_1-1000
ln -s ../ls-1_1-1000
echo "Patience, the `basename $0` takes its time"
for i in `cat ls-1_1-1000`
	do
