#!/bin/bash
#
# Fs_MODER.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_MODER.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_MODER.sh Fs.png &> /dev/null"
./Fs_licet_MODER.sh Fs.png &> /dev/null
...
ffmpeg -y -i \
	...
	-c qtrle Fs_MODER_on_black_nLOGO.mov
