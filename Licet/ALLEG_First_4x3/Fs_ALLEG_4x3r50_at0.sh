#!/bin/bash
#
# Fs_ALLEG_4x3r50_at0.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_ALLEG_4x3r50_at0.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_ALLEG_4x3r50_at0.sh Fs_4x3_at0.png &> /dev/null"
./Fs_licet_ALLEG_4x3r50_at0.sh Fs_4x3_at0.png &> /dev/null

cd Fs_ALLEG_4x3_at0.d/

cat ../ls-1_9999|head -n250 > ../ls-1_250

ls -1 Fs_ALLEG_4x3_at0-????.png | \
	sed 's/Fs_ALLEG_4x3_at0-//'|sed 's/.png//' > ../ls-1_250
...
for i in $(<../ls-1_235r)
	do
		j=`echo $i+15|bc`
		mv -v Fs_ALLEG_4x3_at0-$i.png Fs_ALLEG_4x3_at0-$j.png
	done

chcase -x 's/ALLEG_4x3_at0-/ALLEG_4x3_at0-00/' Fs_ALLEG_4x3_at0-??.png
chcase -x 's/ALLEG_4x3_at0-/ALLEG_4x3_at0-0/' Fs_ALLEG_4x3_at0-???.png

cat ../ls-1_250 | head -n15 > ../ls-1_15

for i in $(<../ls-1_15)
	do
		cp -a Fs_ALLEG_4x3_at0-0016.png Fs_ALLEG_4x3_at0-$i.png
	done
...
for i in $(<../ls-1_15)
	do
		...
		composite -define png:color-type=6 Fs_ALLEG_4x3_at0-$i.png \
			-blend ${perc}x${percrev} ../transp_00_768.png \
			Fs_ALLEG_4x3_at0-${i}.png
	done
...
for i in $(<../ls-1_121-160)
	do
		cp -a Fs_ALLEG_4x3_at0-0120.png Fs_ALLEG_4x3_at0-$i.png
	done
...
# Needed here?
chcase -x 's/ALLEG_4x3_at0-/ALLEG_4x3_at0-0/' Fs_ALLEG_4x3_at0-???.png
echo "chcase -x 's/ALLEG_4x3_at0-/ALLEG_4x3_at0-0/'..."
#read FAKE
cat ../ls-1_250 | tail -n90 > ../ls-1_161-250

for i in $(<../ls-1_161-250)
	do
		cp -av Fs_ALLEG_4x3_at0-0160.png Fs_ALLEG_4x3_at0-${i}.png
	done
...
echo "... black_bkg-$i.png, the last one ..." ;
#read FAKE
...
echo "... black_bkg-0070.png black_bkg ..." ;
#read FAKE
...
mkdir -p Fs_ALLEG_4x3_at0_on_black.d/

# Not entering in that dir here, see the command below!
#cd Fs_ALLEG_4x3_at0_on_black.d/

echo "To do now:"
echo "Fs_ALLEG_4x3_at0_on_black.d"

for i in $(<ls-1_250)
	do
		composite -define png:color-type=6 \
			Fs_ALLEG_4x3_at0.d/Fs_ALLEG_4x3_at0-$i.png \
			Fs_ALLEG_4x3_at0_black.d/black_bkg-$i.png \
			Fs_ALLEG_4x3_at0_on_black.d/Fs_ALLEG_4x3_at0_on_black-$i.png
	done

mkdir -p Fs_ALLEG_4x3_at0_on_black_nLOGO.d/

# Not entering in that dir here, see the command below!
#cd Fs_ALLEG_4x3_at0_on_black_nLOGO.d/
...
for i in $(<ls-1_250)
	do
		...
		Fs_Flowstamp_nSlow2read.d/Fs_Flowstamp_nSlow2read.$i.png \
		Fs_ALLEG_4x3_at0_on_black.d/Fs_ALLEG_4x3_at0_on_black-$i.png \
		Fs_ALLEG_4x3_at0_on_black_nLOGO.d/Fs_ALLEG_4x3_at0_on_black_nLOGO-$i.png
	done
echo "... Is compositing of Flowstamp and slow2read on black OK? ..."
echo "Next is creating the qtrle mov"
#read FAKE

ffmpeg -y -framerate 50 -i \
	Fs_ALLEG_4x3_at0_on_black_nLOGO.d/Fs_ALLEG_4x3_at0_on_black_nLOGO-%4d.png \
	-c qtrle -r 50 Fs_ALLEG_4x3r50_at0_on_black_nLOGO.mov
