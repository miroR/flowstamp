#!/bin/bash
#
# Fs_MODER_at00000.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_MODER_at00000.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_MODER_at00000.sh Fs_at00000.png &> /dev/null"
./Fs_licet_MODER_at00000.sh Fs_at00000.png &> /dev/null
...
ffmpeg -y -i \
	...
	-c qtrle Fs_MODER_at0_on_black_nLOGO.mov
