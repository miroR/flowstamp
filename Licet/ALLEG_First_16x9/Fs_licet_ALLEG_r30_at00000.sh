#!/bin/bash
#
# Fs_licet_ALLEG_r30_at00000.sh -- this script is part of Flowstamp program
#
...
r1=`echo $1|sed 's/.png//'`
r1r=`echo $1|sed 's/_at00000/_ALLEG_at0/'|sed 's/.png//'`
echo \$r1: ; echo $r1
echo \$r1r: echo $r1r
echo -n \${wid}: ; echo ${wid} ;
echo -n \${hei}: ; echo ${hei} ;
...
for i in `cat ls-1_1-250`
	do
		convert -define png:color-type=6 $r1r.png \
			-crop 768x576+0+`echo $i*10|bc` $r1r-$i.png
