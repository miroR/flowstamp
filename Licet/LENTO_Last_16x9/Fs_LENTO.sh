#!/bin/bash
#
# Fs_LENTO.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_LENTO.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_LENTO.sh Fs.png &> /dev/null"
./Fs_licet_LENTO.sh Fs.png &> /dev/null
...
ffmpeg -y -i \
	...
	-c qtrle Fs_LENTO_on_black_nLOGO.mov
