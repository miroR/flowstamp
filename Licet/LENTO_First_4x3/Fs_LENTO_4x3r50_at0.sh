#!/bin/bash
#
# Fs_LENTO_4x3r50_at0.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_LENTO_4x3r50_at0.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_LENTO_4x3r50_at0.sh Fs_4x3_at0.png &> /dev/null"
./Fs_licet_LENTO_4x3r50_at0.sh Fs_4x3_at0.png &> /dev/null

cd Fs_LENTO_4x3_at0.d/

cat ../ls-1_9999|head -n900 > ../ls-1_900

ls -1 Fs_LENTO_4x3_at0-????.png | sed 's/Fs_LENTO_4x3_at0-//'|sed 's/.png//' > \
	../ls-1_900
...
for i in $(<../ls-1_900r)
	do
		j=`echo $i+200|bc`
		mv -v Fs_LENTO_4x3_at0-$i.png Fs_LENTO_4x3_at0-$j.png
	done

chcase -x 's/LENTO_4x3_at0-/LENTO_4x3_at0-00/' Fs_LENTO_4x3_at0-??.png
chcase -x 's/LENTO_4x3_at0-/LENTO_4x3_at0-0/' Fs_LENTO_4x3_at0-???.png

cat ../ls-1_9999|head -n200 > ../ls-1_200

for i in $(<../ls-1_200)
	do
		cp -av Fs_LENTO_4x3_at0-0201.png Fs_LENTO_4x3_at0-$i.png
	done

ls -1 Fs_LENTO_4x3_at0-????.png | sed 's/Fs_LENTO_4x3_at0-//' | \
	sed 's/.png//' > ../ls-1_1100
...
cp -av black_00__*.png ../

echo "all transp*.png created, Fs_LENTO_4x3_at0-..._fadein.png next"
...
for i in $(<../ls-1_100)
	do
		...
		composite -define png:color-type=6 Fs_LENTO_4x3_at0-$i.png \
			-blend ${perc}x${percrev} ../transp_00_768.png \
			Fs_LENTO_4x3_at0-${i}_fadein.png
	done
...
for i in $(<../ls-1_100)
	do
		mv -v Fs_LENTO_4x3_at0-$i.png JIC/
	done

chcase -x 's/_fadein//' Fs_LENTO_4x3_at0-????_fadein.png
...
for i in $(<../ls-1_329-416)
	do
		cp -av Fs_LENTO_4x3_at0-0417.png Fs_LENTO_4x3_at0-${i}.png
	done
...
for i in $(<../ls-1_567-654)
	do
		cp -av Fs_LENTO_4x3_at0-0655.png Fs_LENTO_4x3_at0-${i}.png
	done
...
for i in $(<../ls-1_919-1006r)
	do
		cp -av Fs_LENTO_4x3_at0-0918.png Fs_LENTO_4x3_at0-${i}.png
	done
...
for i in $(<../ls-1_1365-1376)
	do
		cp -av Fs_LENTO_4x3_at0-1364.png Fs_LENTO_4x3_at0-${i}.png
	done
...
for i in $(<../ls-1_1157-1376)
	do
		cp -av Fs_LENTO_4x3_at0-1156.png Fs_LENTO_4x3_at0-${i}.png
	done
...
mkdir -p Fs_LENTO_4x3_at0_black.d/
cd Fs_LENTO_4x3_at0_black.d/
...
mkdir -p Fs_LENTO_4x3_at0_on_black.d/

# Not entering in that dir here, see the command below!
#cd Fs_LENTO_4x3_at0_on_black.d/

echo "To do now:"
echo "Fs_LENTO_4x3_at0_on_black.d"

for i in $(<ls-1_1376)
	do
		composite -define png:color-type=6 \
			Fs_LENTO_4x3_at0.d/Fs_LENTO_4x3_at0-$i.png \
			Fs_LENTO_4x3_at0_black.d/black_bkg-$i.png \
			Fs_LENTO_4x3_at0_on_black.d/Fs_LENTO_4x3_at0_on_black-$i.png
	done

echo "... Is ...d/black_bkg-... OK? ..."

mkdir -p Fs_LENTO_4x3_at0_on_black_nLOGO.d/

# Not entering in that dir here, see the command below!
#cd Fs_LENTO_4x3_at0_on_black_nLOGO.d/
...
for i in $(<ls-1_1376)
	do
		composite -define png:color-type=6 \
			...
			Fs_LENTO_4x3_at0_on_black.d/Fs_LENTO_4x3_at0_on_black-$i.png \
			Fs_LENTO_4x3_at0_on_black_nLOGO.d/Fs_LENTO_4x3_at0_on_black_nLOGO-$i.png
	done
echo "... Is compositing of Flowstamp on black OK? ..."
echo "Next is creating the qtrle mov"

ffmpeg -y -framerate 50 -i \
	Fs_LENTO_4x3_at0_on_black_nLOGO.d/Fs_LENTO_4x3_at0_on_black_nLOGO-%4d.png \
	-c qtrle -r 50 Fs_LENTO_4x3r50_at0_on_black_nLOGO.mov
