#!/bin/bash
#
# Fs_LENTO_4x3_at0.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_LENTO_4x3_at0.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_LENTO_4x3_at0.sh Fs_4x3_at0.png &> /dev/null"
./Fs_licet_LENTO_4x3_at0.sh Fs_4x3_at0.png &> /dev/null
...
ffmpeg -y -i \
	...
	-c qtrle Fs_LENTO_4x3_at0_on_black_nLOGO.mov
