#!/bin/bash
#
# Fs_ALLEG.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_ALLEG.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_ALLEG.sh Fs.png &> /dev/null &> /dev/null"
./Fs_licet_ALLEG.sh Fs.png &> /dev/null &> /dev/null
...
ffmpeg -y -i Fs_ALLEG_on_black_nLOGO.d/Fs_ALLEG_on_black_nLOGO-%4d.png \
	-c qtrle Fs_ALLEG_on_black_nLOGO.mov
