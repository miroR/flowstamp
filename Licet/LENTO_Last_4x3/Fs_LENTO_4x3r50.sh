#!/bin/bash
#
# Fs_LENTO_4x3r50.sh -- this script is part of Flowstamp program
#
...
if [ -e "Fs_4x3.png" ]
	then
		...
		then
			...
			#cp -av ../Auxil-contrib/make_licet ../Make_licet/
			#cd ../Make_licet/
			#./make_licet East
			#cd -
...
echo "./Fs_licet_LENTO_4x3r50.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_LENTO_4x3r50.sh Fs_4x3.png &> /dev/null"
./Fs_licet_LENTO_4x3r50.sh Fs_4x3.png &> /dev/null
...
ffmpeg -y -framerate 50 -i \
	...
	-c qtrle -r 50 Fs_LENTO_4x3r50_on_black_nLOGO.mov
