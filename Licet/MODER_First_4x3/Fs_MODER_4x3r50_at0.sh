#!/bin/bash
#
# Fs_MODER_4x3r50_at0.sh -- this script is part of Flowstamp program
#
...
echo "./Fs_licet_MODER_4x3r50_at0.sh clutters with excessive output, silenced:"
echo "===> ./Fs_licet_MODER_4x3r50_at0.sh Fs_4x3_at0.png &> /dev/null"
./Fs_licet_MODER_4x3r50_at0.sh Fs_4x3_at0.png &> /dev/null
...
ffmpeg -y -framerate 50 -i \
	...
	-c qtrle -r 50 Fs_MODER_4x3r50_at0_on_black_nLOGO.mov
